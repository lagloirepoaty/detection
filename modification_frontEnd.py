# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 12:16:01 2024

@author: eurek_3tyepin
"""
#css
#=======================================mise en forme================================================#
# Configuration de la page
# import librairieimport streamlit as st
import pandas as pd
...
import io
st.set_page_config(page_title="DECTECTION DES FAUX BILLETS", layout="wide")
...
def appliquer_dark_mode(dark_mode):
    ...
    if dark_mode:
     ...
     st.markdown("""
            ...
            </style> """, unsafe_allow_html=True""",unsafe_allow_html=Tr 
run toggle switch
